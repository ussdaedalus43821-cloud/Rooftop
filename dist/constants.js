...
export function getFranchiseOption(key) {
    const option = FRANCHISE_OPTIONS.find((f) => f.key === key);
    if (!option)
        throw new Error(`Unknown franchise key: ${key}`);
    return option;
}
export function franchisesInCategory(category) {
...
export const FRANCHISE_CATALOGS = {
    toyota: [
...
export const ALL_FRANCHISE_MODELS = Object.values(FRANCHISE_CATALOGS).flat();
...
export const OVERHEAD_MONTHLY = 38000; // rent, utilities, insurance, admin
