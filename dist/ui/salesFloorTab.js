...
function draftToTerms(deal, draft) {
...
export const salesFloorTab = {
    ...
    render(ctx) {
        ...
        if (selectedDealId && !negotiating.find((x) => x.id === selectedDealId))
            selectedDealId = null;
...
//# sourceMappingURL=salesFloorTab.js.map