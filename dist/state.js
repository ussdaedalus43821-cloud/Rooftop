...
import { CURTAILMENT_FRACTION, CURTAILMENT_GRACE_DAYS, CURTAILMENT_INTERVAL_DAYS, CURTAILMENT_THRESHOLD_DAYS, FLOORPLAN_DAILY_RATE, getFranchiseOption, OVERHEAD_MONTHLY, STAFF_FIRST_NAMES, STAFF_LAST_NAMES, } from "./constants.js";
...
function makeStaff(rng, role, skill, salary, commission) {
...
export function createDealership(rng, id, name, franchiseKey, foundedDay, startingCapital) {
...
export function createNewGame(seed = Date.now(), franchiseKey = "ford") {
